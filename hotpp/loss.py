...
class Loss:
    ...
    atom_prop = ["forces", "spin_torques", "direct_forces", "peratom_tensor", "peratom_l3_tensor"]
    structure_prop = ["energy", "virial", "dipole", "polarizability", "l3_tensor", "stress"]
